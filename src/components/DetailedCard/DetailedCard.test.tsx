...
test('renders the relevant card data', async () => {
  ...
  const birthYearElement = screen.findByText(`Birth Year: ${mockActress.birth_year}`);
  const nationalityElement = screen.findByText(`Nationality: ${mockActress.nationality}`);
